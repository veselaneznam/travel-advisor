...
class BoardingCardJsonRepresenterTest extends TestCase
{
     ...
     * @throws MissingArgumentException
     */
    public function testToStringBusCard()
    {
        $expected = [
            'transportationType' => BoardingCardType::BUS,
            'startDirection' => 'Sofia',
     ...
     * @throws MissingArgumentException
     */
    public function testToStringTrainCard()
    {
        $expected = [
            'transportationType' => BoardingCardType::TRAIN,
            'startDirection' => 'Sofia',
     ...
     * @throws MissingArgumentException
     */
    public function testToStringAirportCard()
    {
        $expected = [
            'transportationType' => BoardingCardType::AIRPORT,
            'startDirection' => 'Sofia',
        ...
        $jsonString = json_encode($expected);
        $item = json_decode($jsonString);
        $boardinCard = AirportCard::createFromJson($item);
        $this->assertEquals(
            '{"instructions":"From Sofia, take flight 12323BBB to Plovdiv. Gate 1B, seat 12V. Get your luggage from Gate B11"}',
            BoardingCardJsonRepresenter::toString($boardinCard)
        );
    }
}