...
use App\Tests\TravelAdvisor\Infrastructure\TestBoardingCardRepository;
...
class BoardingCardServiceTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->boardingCardRepository = new TestBoardingCardRepository();
    }
    ...
    public function testGetFirst($jsonString, $expectedResult)
    {
        ...
        $boardingcardService = new BoardingCardService($this->boardingCardRepository);
        $firstElement = $boardingcardService->getFirstCardAsArray($unsortedBoardingCards);
    ...
    public function testSort($jsonString, $expected)
    {
        ...
        $sortedBordingCards = $boardingcardService->getSortedCardsAsArray($unsortedBoardingCards);
